...
::: {style="font-size: 0.6em; font-family: monospace; " .position .absolute top="5em"}
[def]{style="color: red; "} `func`(`arg1`, `arg2`, ..., `kwarg1=val1`, `kwarg2=val2`,...):
  </br>&nbsp;&nbsp;&nbsp;do_this()
  </br>&nbsp;&nbsp;&nbsp;...
  </br>&nbsp;&nbsp;&nbsp;do_that()
  </br>&nbsp;&nbsp;&nbsp;...
...
::: {.fragment style="font-size: 0.6em; font-family: monospace; " .position .absolute bottom="10.1em"}
from [acme]{.esi-color} import [ParallelMap]{.esi-color}

with [ParallelMap]{.esi-color}(`func`, `arg1`, `arg2`, ..., `kwarg1=val1`, `kwarg2=val2`,...,
:::

::: {.fragment style="font-size: 0.6em; font-family: monospace; " .position .absolute bottom="8.81em"}
from [acme]{.esi-color} import [ParallelMap]{.esi-color}

with [ParallelMap]{.esi-color}(`func`, `arg1`, `arg2`, ..., `kwarg1=val1`, `kwarg2=val2`,...,
  </br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  [kw1=v1]{.esi-color}, [kw2=v2]{.esi-color}, ...) as [pmap]{.esi-color}:
:::

::: {.fragment style="font-size: 0.6em; font-family: monospace; " .position .absolute bottom="7.51em"}
from [acme]{.esi-color} import [ParallelMap]{.esi-color}

with [ParallelMap]{.esi-color}(`func`, `arg1`, `arg2`, ..., `kwarg1=val1`, `kwarg2=val2`,...,
  </br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  [kw1=v1]{.esi-color}, [kw2=v2]{.esi-color}, ...) as [pmap]{.esi-color}:
  </br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[pmap]{.esi-color}.compute()
:::
...
::: {data-id="box1" style="background: rgba(0,0,0,0); width: 100%; height: 1em; border: 0.1em solid red; " .absolute top="10.3em" left="-0.2em" .fade}
:::


## Back To SLURM Connectomes... {auto-animate=true auto-animate-unmatched="false" transition="fade-in"}
...
[ACME [- INFO -]{style="color: DodgerBlue; "}]{style="font-weight: bold; "} Results have been saved to /cs/home/fuertingers/neuro-bsp/compute_connectome.h5
:::
...
::: {data-id="box1" style="background: rgba(0,0,0,0); width: 100%; height: 0.6em; border: 0.1em solid red; " .absolute top="12.9em" left="-0.2em" .fade}
:::
